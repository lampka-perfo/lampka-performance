...
(() => {
  ...
  // ── Custom element ──────────────────────────────────────────────────────
  // Themeable via CSS custom properties on the host element:
  //   --is-frame-bg, --is-text, --is-accent, --is-ring
  const stylesheet =
    ':host{display:inline-block;position:relative;vertical-align:top;' +
    '  font:13px/1.3 system-ui,-apple-system,sans-serif;' +
    '  color:var(--is-text,rgba(0,0,0,.55));' +
    '  width:240px;height:160px}' +
    '.frame{position:absolute;inset:0;overflow:hidden;background:var(--is-frame-bg,rgba(0,0,0,.04))}' +
    ...
    '  background:#fff;box-shadow:0 0 0 1.5px var(--is-accent,#c96442),0 1px 3px rgba(0,0,0,.3);' +
    ...
    ':host([data-reframe]) .frame{box-shadow:0 0 0 2px var(--is-accent,#c96442)}' +
    ...
    ':host([data-over]) .frame{outline:2px solid var(--is-accent,#c96442);outline-offset:-2px;' +
    '  background:color-mix(in srgb, var(--is-accent,#c96442) 10%, transparent)}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed var(--is-ring,rgba(0,0,0,.25));' +
    '  transition:border-color .12s}' +
    ':host([data-over]) .ring{border-color:var(--is-accent,#c96442)}' +
